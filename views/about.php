<section class="flex flex-col justify-center items-center">
    <h1>About Us</h1>
    <p>At NovaCraft Studio, we bring ideas to life through innovative design. As a full-service graphic and UI/UX design agency, we specialize in creating visually stunning and user-friendly experiences that connect brands with their audiences.<br>
